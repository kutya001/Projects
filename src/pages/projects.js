...
export function renderProjectsPage(S, mount, callbacks = {}) {
  ...
  const headerHtml = renderUnifiedHeader(S, {
    ...
    actions: `
      ...
      <button class="btn pri sm" id="btnAddPrj" style="font-weight:700;display:inline-flex;align-items:center;gap:4px">
    ...
    `,
    views: { ent: 'p', current: vMode }
  });

  mount.innerHTML = `
    ${headerHtml}
    <div id="pContent" class="page-content"></div>`;
